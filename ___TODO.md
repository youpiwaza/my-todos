...
1. Voir spectacle chateau sedan pour quand vigi reviendra [hey](https://www.chateau-fort-sedan.fr/evenements)
...
1. WP > Création des champs personnalisés
    1. 🧽 Revoir gestion de l'utilisation du moteur (pour le moment catégorie "Moteurs" avec les véhicules compatibles)
...
3. Tâches prioritaires suite au RDV client
    1. Créer les pages statiques & pré-remplir le contenu
       1. a propos (theme bike)
       2. service (theme bike)
       3. blogs (theme hardware store)
       4. page des marques
    2. Footer / Pied de page
       1. Faire une proposition de menu (trier les anciens liens)
       2. Reprendre les images bancaires du pied de page de l'ancien site
    3. 📌 Créer un compte admin pour PB Modelisme
       1. Créer le compte
       2. Noter identifiants dans doc secret
       3. 📧 Envoyer identifiants avec liste des pages admin à recetter
       4. Même chose pour nonore
    4. 🔍🌱 Fonctionnalités++ a mettre en place
    ...
    5. 🔍 Ajouter un état produit : "Produit plus fabriqué" ~possibilité d'avoir en stocks mais ne sera pas renouvelé
    6. 🔍 veille [suggestions de plugins](https://dev.pb-modelisme.com/wp-admin/admin.php?page=pwb_suggestions)
4. 📌 Faire un test avec le prix importé en HT
    1. Import OK
    2. Affichage sur site ?
    3. Calcul TTC ok ? arrondi machin mes couilles
    4. Faire valider par clients
5. Choix d'une gestion des réductions en cas de prix réduit pour commande de multiples éléments
6. 📝 Gestion de l'import des images produits
    1. ⏳ Récupération des fichiers images, afin de les balancer sur le nouveau serveur
7. Importer les marques
    1. 📝 Elimination des doublons, chaque marque n'a qu'une entrée
    2. 📝 Plus de marquées dédiées à certaines catégories
8. Importer l'ensemble d'une catégorie de produits
