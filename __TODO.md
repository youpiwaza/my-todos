   ...
   1. Mettre en place la sécurité docker en vérifiant que tout roule toujours
      1. Automatic security benchmark [Docker bench security](https://github.com/docker/docker-bench-security)
          ...
          4. ✅ Standalone containers recos (docker run)
             ...
             2. Use label files ? No > Maintenance in 1 place + ansible's docker_container doesn't support
                1. Client
                2. Project
                3. Date
                4. Test ?
          ...
          6. ⏩ Via ansible
          7. ⏩ Compose containers recos (docker compose)
          8. ⏩ Via ansible
          9. ⏩ Services recos (docker swarm & docker stack)
          10. ⏩ Via ansible
      2. [Unbuntu security benchmark webinar 30mn](https://ubuntu.com/engage/linux_security_webinar)
